...
public class AdminImagensController : Controller
{
    ...
    public async Task<IActionResult> UploadFiles(List<IFormFile> files)
    {
        ...
        var filePath = Path.Combine(_hostingEnvironment.WebRootPath, _myConfig.Folder);
    ...
    public IActionResult GetImagens()
    {
        ...
        var userImagesPath = Path.Combine(_hostingEnvironment.WebRootPath, _myConfig.Folder);

        DirectoryInfo dir = new(userImagesPath);
        FileInfo[] files = dir.GetFiles();
        model.PathImagesProduto = _myConfig.Folder;
    ...
    {
        string _imagemDeleta = Path.Combine(_hostingEnvironment.WebRootPath, _myConfig.Folder + "\\", fname);
